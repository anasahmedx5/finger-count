...
while True:
    ...
    if hands:
        ...
        elif fingerUp==[0,1,0,0,0] or fingerUp==[1,0,0,0,0]or fingerUp==[0,0,0,0,1]:
            cv2.putText(frame,'Finger count:1',(20,460),cv2.FONT_HERSHEY_COMPLEX,1,(255,255,255),1,cv2.LINE_AA)    
        elif fingerUp==[0,1,1,0,0] or fingerUp==[0,0,0,1,1] or fingerUp==[1,1,0,0,0] :
            cv2.putText(frame,'Finger count:2',(20,460),cv2.FONT_HERSHEY_COMPLEX,1,(255,255,255),1,cv2.LINE_AA)
        elif fingerUp==[0,1,1,1,0] or fingerUp==[0,0,1,1,1] or fingerUp==[1,1,1,0,0]:
